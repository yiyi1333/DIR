...
class CausalAttNet(nn.Module):
    ...
    def __init__(self, causal_ratio):
        ...
        self.conv1 = ARMAConv(in_channels=3, out_channels=args.channels)
    ...
    def forward(self, data):
        edge_attr = torch.ones(data.edge_index.shape[1]).to(device)
...
if __name__ == "__main__":
    ...
    mutag = TUDataset(root=path, name="PROTEINS")
    ...
    experiment_name = f'tech-graph.{args.type}.{args.reg}.{args.commit}.netlr_{args.net_lr}.batch_{args.batch_size}'\
