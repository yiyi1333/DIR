...
if __name__ == "__main__":
    ...
    parser.add_argument('--epoch', default=150, type=int, help='training iterations')
    ...
    dataset = get_dataset(dataset_dir='data/', dataset_name='Graph-SST2', task=None)
    ...
    for seed in args.seed:
        ...
        cnt, last_val_acc, last_train_acc, last_causal_acc, last_conf_acc = 0, 0, 0, 0, 0
        for epoch in range(args.epoch):
            ...
            for graph in train_loader:
                ...
                causal_loss = F.cross_entropy(causal_out, labels, reduction='mean')
                conf_loss = F.cross_entropy(conf_out, labels, reduction='mean')
                ...
                if args.reg:
                    ...
                    for idx, causal in enumerate(causal_rep):
                        ...
                        tmp = F.cross_entropy(rep_out, graph.y[idx].repeat(rep_out.size(0)).long(), reduction='none')
            ...
            with torch.no_grad():
                ...
                if val_acc > last_val_acc:
                    ...
                    last_causal_acc = causal_acc
                    last_conf_acc = conf_acc


            
        all_info['causal_acc'].append(last_causal_acc)
        all_info['conf_acc'].append(last_conf_acc)
