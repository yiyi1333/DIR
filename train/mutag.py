...
if __name__ == "__main__":
    ...
    parser.add_argument("--epoch", default=500, type=int, help="training iterations")
    ...
    parser.add_argument(
        "--net_lr", default=8e-4, type=float, help="learning rate for the predictor"
    )
    parser.add_argument(
    ...
    mutag = TUDataset(root=path, name="MUTAG")
    ...
    for seed in args.seed:
        ...
        model = PMPGNN(
            args.input_channels, args.channels, num_classes, layers=args.layers, heads=1
        ).to(device)
